...
public class Gasoline extends Car {
    ...
    public Gasoline(boolean used, double bprice, double sprice, String brand, String model, double cylinder, double mileage,String plate,int typeC, int doors, boolean polarized, double gasolineCapacity, double gasolineConsume, int typeG, double prid, int year, String image, int[][]matriz,double prid2, int year2, String image2, int tipoc) {
        super(used,bprice,sprice,brand,model,cylinder,mileage,plate,typeC,doors,polarized,prid,year,image,matriz,prid2,year2,image2,tipoc);
